                        ...
                        <div className="flex flex-col bg-white rounded-sm shadow">
                            ...
                            <div className="flex flex-col gap-2 py-3 text-sm overflow-hidden">
                                ...
                                <div className="flex flex-col gap-2 border-b px-4">
                                    <span className="font-medium text-xs">PRIX</span>
                                    ...
                                    <div className="flex gap-3 items-center justify-between mb-2 min-w-full">
                                        <span className="flex-1 border px-4 py-1 rounded-sm text-gray-800 bg-gray-50">TND{price[0].toLocaleString()}</span>
                                        <span className="font-medium text-gray-400">jusqu'à</span>
                                        <span className="flex-1 border px-4 py-1 rounded-sm text-gray-800 bg-gray-50">TND{price[1].toLocaleString()}</span>
                                    </div>
                                </div>
                                {/* price slider filter */}
