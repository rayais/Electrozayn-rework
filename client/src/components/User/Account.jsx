                            ...
                            <div className="flex-1 overflow-hidden shadow bg-white">
                                ...
                                <div className="flex flex-col gap-12 m-4 sm:mx-8 sm:my-6">
                                    ...
                                    <div className="flex flex-col gap-5 items-start">
                                        <span className="font-medium text-lg">Information <Link to="/account/update" className="text-sm text-primary-blue font-medium ml-8 cursor-pointer">Modifier</Link></span>
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <h2 className="text-sm">Votre Sexe : </h2>
                                            <div className="flex items-center gap-8" id="radioInput">
                                                <div className="flex items-center gap-4 inputs text-gray-500 cursor-not-allowed">
                                                    ...
                                                    <label htmlFor="male" className="cursor-not-allowed">Masculin</label>
                                                </div>
                                                <div className="flex items-center gap-4 inputs text-gray-500 cursor-not-allowed">
                                                    <input type="radio" name="gender" checked={user.gender === "female"} id="female" className="h-4 w-4 cursor-not-allowed" disabled />
                                                    <label htmlFor="female" className="cursor-not-allowed">Feminin</label>
                                                </div>
                                            </div>
                                        </div>
                                        {/* <!-- gender --> */}
                                    ...
                                    <div className="flex flex-col gap-5 items-start">
                                        <span className="font-medium text-lg">Adresse Email
                                            <Link to="/account/update" className="text-sm text-primary-blue font-medium ml-3 sm:ml-8 cursor-pointer">Modifier</Link>
                                            <Link to="/password/update" className="text-sm text-primary-blue font-medium ml-3 sm:ml-8">Changer mot de passe</Link>
                                        </span>
                                    ...
                                    {/* <!-- mobile number info --> */}
                                    <div className="flex flex-col gap-5 items-start">
                                        <span className="font-medium text-lg">Numéro Mobile
                                            <span className="text-sm text-primary-blue font-medium ml-3 sm:ml-8 cursor-pointer" id="mobEditBtn">Modifier</span>
                                        </span>

                                        <div className="flex items-center gap-3">
                                            <div className="flex flex-col gap-0.5 sm:w-64 px-3 py-1.5 rounded-sm border bg-gray-100 cursor-not-allowed focus-within:border-primary-blue">
                                                <label className="text-xs text-gray-500">Numéro Mobile</label>
