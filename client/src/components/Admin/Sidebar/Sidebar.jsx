...
const Sidebar = ({ activeTab, setToggleSidebar, user }) => {
                    ...
                    return (
                        <>
                            {label === "Logout" ? (
                                ...
                                <Link to={ref} onClick={()=>setToggleSidebar(false)} className={`${activeTab === index ? "bg-gray-700" : "hover:bg-gray-700"} flex gap-3 items-center py-3 px-4 font-medium`}>
                                    <span>{icon}</span>
                                    <span>{label}</span>
                                </Link>
                            )}
