import { NEW_ORDER_REQUEST, NEW_ORDER_SUCCESS,
     ORDER_DETAILS_SUCCESS, ORDER_DETAILS_FAIL, NEW_ORDER_FAIL, CLEAR_ERRORS, 
     MY_ORDERS_FAIL, MY_ORDERS_SUCCESS, MY_ORDERS_REQUEST,  UPDATE_ORDER_RESET, 
     ALL_ORDERS_REQUEST ,ALL_ORDERS_SUCCESS, ALL_ORDERS_FAIL,
     UPDATE_ORDER_REQUEST, UPDATE_ORDER_SUCCESS, DELETE_ORDER_REQUEST, DELETE_ORDER_SUCCESS, DELETE_ORDER_FAIL,
     UPDATE_ORDER_FAIL, DELETE_ORDER_RESET, ORDER_DETAILS_REQUEST } from "../constants/orderConstants";
